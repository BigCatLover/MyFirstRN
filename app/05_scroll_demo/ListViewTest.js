...
import {ListView, Text, RefreshControl, StyleSheet, View, Image,ImageBackground} from "react-native";
...
//Image => 使用安装项目目录下的图片：require('image!timg') 使用网络图片：{uri : '图片地址'}
